...
func initializeLoggerV2(logInitializerObject LogInitializerObject) {
...
func GetLoggerV2(logInitializerObject LogInitializerObject) *logrus.Logger {
	logInit.Do(func() {
		initializeLoggerV2(logInitializerObject)
	})
	return loggerV2
}
